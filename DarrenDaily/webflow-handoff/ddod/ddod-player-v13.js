(function(){
  ...
  /* ---------- nav reveals on scroll ----------
     The bar starts off-screen (.ddod-nav is hidden at rest) so the hero opens
     clean, and slides in once the page moves. 24px is the same threshold the
     rest of the site uses to flip .dd-nav solid, so the pages behave alike.
     Synced once on load too, in case the browser restores a scroll position.
     ...
     One comparison per scroll event is what the rest of the site does. */
