(function(){
  ...
  function mountForm(){
    ...
    /* The audiobook form, not the plain DarrenDaily opt-in. It subscribes to
       DarrenDaily AND delivers the Compound Effect audiobook, which is the
       offer this page now makes. Identified from tce.darrenhardy.com's own
       markup: it is the form rendered under the ACCESS THE AUDIO BOOK heading
       (target #hs_form_target_widget_1739784326084), redirecting to
       /resource-delivery. The previous DD-only form was
       41958dbb-3c3a-439b-b747-bb96acf50680. */
    s.onload=function(){ if(window.hbspt) hbspt.forms.create({
      region:'na1', portalId:'2518645', formId:'83c40a17-5190-48bf-b33c-23452ee4bd6e', target:'#ddJoinForm' }); };
